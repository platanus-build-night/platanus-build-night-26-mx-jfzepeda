# Juan Felipe Zepeda Del Toro — Platanus Build Night — Ciudad de México Project
...
- Juan Felipe Zepeda Del Toro ([@jfzepeda](https://github.com/jfzepeda))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-build-night/platanus-build-night-26-mx-jfzepeda.git
